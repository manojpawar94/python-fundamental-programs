...
get_ipython().run_cell_magic('timeit', '-n 100', 's = pd.Series(np.random.randint(0,1000,1000))\nfor label, value in s.iteritems():\n    s.loc[label]= value+2')


# In[ ]:


get_ipython().run_cell_magic('timeit', '-n 100', 's = pd.Series(np.random.randint(0,1000,10000))\ns+=2')
